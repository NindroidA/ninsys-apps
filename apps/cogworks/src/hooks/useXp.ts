...
export function useUpdateXpConfig(guildId: string) {
  ...
  return useMutation({
    mutationFn: async (data: Partial<XpConfig>) => {
      const result = await apiPost<XpConfig>(
        `/guilds/${guildId}/xp/config/update`,
        data
      );
...
export function useChannelMultipliers(guildId: string) {
  return useQuery({
    ...
    queryFn: async () => {
      const result = await apiGet<ChannelMultiplier[]>(
        `/guilds/${guildId}/xp/multipliers`
      );
  ...
  return useMutation({
    mutationFn: async (data: { channelId: string; multiplier: number }) => {
      const result = await apiPost(
        `/guilds/${guildId}/xp/multiplier/set`,
        data
      );
...
export function useRemoveChannelMultiplier(guildId: string) {
  ...
  return useMutation({
    mutationFn: async (channelId: string) => {
      const result = await apiPost(
        `/guilds/${guildId}/xp/multiplier/remove`,
        { channelId }
      );
...
export function useRoleRewards(guildId: string) {
  return useQuery({
    ...
    queryFn: async () => {
      const result = await apiGet<RoleReward[]>(
        `/guilds/${guildId}/xp/role-rewards`
      );
      if (!result.success || !result.data) return [];
      return Array.isArray(result.data) ? result.data : [];
    },
...
export function useAddRoleReward(guildId: string) {
  ...
  return useMutation({
    mutationFn: async (data: {
      ...
      const result = await apiPost(
        `/guilds/${guildId}/xp/role-rewards/add`,
        data
      );
...
export function useDeleteRoleReward(guildId: string) {
  ...
  return useMutation({
    mutationFn: async (rewardId: string) => {
      const result = await apiPost(
        `/guilds/${guildId}/xp/role-rewards/remove`,
        { rewardId }
      );
...
export function useSetUserXp(guildId: string) {
  ...
  return useMutation({
    mutationFn: async (data: { userId: string; xp: number }) => {
      const result = await apiPost(
        `/guilds/${guildId}/xp/user/${data.userId}/set`,
        { xp: data.xp }
      );
...
export function useResetUserXp(guildId: string) {
  ...
  return useMutation({
    mutationFn: async (userId: string) => {
      const result = await apiPost(
        `/guilds/${guildId}/xp/user/${userId}/reset`
      );
...
export function useXpImportHistory(guildId: string) {
  return useQuery({
    ...
    queryFn: async () => {
      const result = await apiGet<XpImportResult[]>(
        `/guilds/${guildId}/import/history?limit=10`
      );
      if (!result.success || !result.data) return [];
      return Array.isArray(result.data) ? result.data : [];
    },
