...
export function StatusPage() {
	const { data: status, isLoading: statusLoading, error: statusError } = usePublicBotStatus();
	...
	return (
		<div className="min-h-screen py-20">
			<SEO
				title="Status"
				description="Real-time status and statistics for the Cogworks Discord bot. Check uptime, latency, and server count."
				path="/status"
			/>
