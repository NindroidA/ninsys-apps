    ...
    updateConfig.mutate(
      {
        ...
        globalStaffRole: form.enableGlobalStaffRole
          ? form.globalStaffRole
          : null,
      },
          ...
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-muted-foreground">
                This will reset custom ban reasons, warning messages, and rules
                text back to the bot's built-in defaults.
              </p>
            </div>
            <Button
              variant="outline"
