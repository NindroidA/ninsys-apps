    ...
    addRule.mutate(
      {
        ...
        maxOpen: Math.min(
          50,
          Math.max(1, Number.parseInt(newMaxOpen, 10) || 5)
        ),
      },
      {
        onSuccess: () => {
        ...
        {!configLoading && !config && (
          <div className="text-center py-12 border border-dashed border-border rounded-lg">
            <p className="text-muted-foreground">
              Smart routing is not configured yet.
            </p>
        ...
        {config && (
          <>
            ...
            <ConfigSection
              ...
              description="How tickets are assigned to staff"
            >
              <Select
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div>
                  ...
                  <input
                    ...
                    value={newTypeId}
                    onChange={(e) =>
                      setNewTypeId(e.target.value.replace(/[^a-z0-9-_]/gi, ""))
                    }
                ...
                <RolePicker
                  ...
                  value={newRoleId}
                  onChange={(v) =>
                    setNewRoleId(typeof v === "string" ? v : null)
                  }
                  label="Staff Role"
