      ...
      <div>
        <Card className="p-8 text-center">
          ...
          <p className="text-sm text-muted-foreground max-w-md mx-auto">
            Data export functionality is under development. You'll be able to
            export all server data including configuration, tickets,
            applications, memory items, and logs for GDPR compliance.
          </p>
        </Card>
      </div>
    </FadeIn>
