          ...
          <div className="flex items-start justify-between mb-8">
            <div>
              ...
              <p className="text-muted-foreground mt-1">
                Choose a server to manage with Cogworks
              </p>
            </div>
            {user && (
          ...
          <FadeIn>
            <div className="text-center py-16">
              ...
              <p className="text-muted-foreground max-w-md mx-auto">
                You don't have admin access to any Discord servers, or you
                haven't added Cogworks to any servers yet.
              </p>
            </div>
          </FadeIn>
        ) : (
                    ...
                    return (
                      <FadeIn key={guild.id}>
                        <Card className="p-4 flex flex-col items-center text-center hover:border-primary/30 transition-colors">
                          ...
                          <h3 className="font-semibold truncate w-full mb-3">
                            {guild.name}
                          </h3>
                          <Button
                            className="w-full"
