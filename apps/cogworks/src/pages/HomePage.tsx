        ...
        <div className="container mx-auto px-4 relative z-10">
          <FadeIn className="max-w-4xl mx-auto">
            ...
            <p className="text-base sm:text-lg lg:text-xl text-muted-foreground mb-8 max-w-xl">
              Cogworks is a powerful Discord bot for ticketing, applications,
              moderation, and more. Free, source-available, and designed for
            ...
            <div className="mt-14 rounded-xl border border-amber-500/20 bg-gradient-to-r from-amber-500/[0.06] to-orange-500/[0.04] p-5 sm:p-6 flex items-start gap-4 max-w-2xl">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-muted-foreground">
                  Manage your bot configuration from the web. The dashboard is
                  in beta — the bot itself is fully stable and production-ready.
                </p>
              </div>
              <Link
                to="/login"
        ...
        <div className="container mx-auto px-4 relative z-10">
          <FadeIn className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto">
              From support tickets to staff applications, Cogworks has all the
              tools to keep your community running smoothly.
            </p>
          </FadeIn>
