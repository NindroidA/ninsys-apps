...
export function FeaturesPage() {
  return (
    <div className="min-h-screen py-20">
      <SEO
        title="Features"
        description="Explore all Cogworks features — tickets, applications, announcements, XP, starboard, bait channel, and more."
        path="/features"
      />
      <div className="container mx-auto px-4">
        ...
        <FadeIn className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Everything you need to manage your Discord server effectively, all
            in one bot.
          </p>
        </FadeIn>
                ...
                <div className="flex-1">
                  <div className="aspect-video rounded-xl bg-card border border-border flex items-center justify-center">
                    <div className="text-center text-muted-foreground">
                      ...
                      <p className="text-xs text-muted-foreground/50 uppercase tracking-wider mt-1">
                        Coming soon
                      </p>
                    </div>
                  </div>
