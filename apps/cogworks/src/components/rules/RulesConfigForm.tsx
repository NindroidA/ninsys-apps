...
import { AlertCircle, CheckCircle2, Loader2, RotateCcw, Send, Trash2 } from "lucide-react";
		...
		<>
			...
			>
				...
				<div>
					<EmojiPicker
						value={form.emoji ?? ""}
						onChange={(emoji) => setForm((prev) => ({ ...prev, emoji: emoji || null }))}
			...
			<ConfigSection title="Rules Message" description="The message posted in the rules channel">
				<div>
					<div className="flex items-center justify-between mb-1.5">
						...
						{form.customText !== null && (
							<button
								type="button"
								onClick={() => setForm((prev) => ({ ...prev, customText: null }))}
					...
					<div className="flex items-center justify-between mt-1">
						<p className="text-xs text-muted-foreground">
							This message will be posted in the rules channel. Users react to acknowledge.
						</p>
