...
import {
  useBaitChannelWhitelist,
  useUpdateBaitChannelWhitelist,
...
export function BaitWhitelistTab({ guildId }: BaitWhitelistTabProps) {
  ...
  const isDirty =
    !deepEqual(roleIds, originalRoleIds) ||
    !deepEqual(userIds, originalUserIds);
  ...
  return (
    <div className="space-y-6 ">
      ...
      <ConfigSection
        ...
        description="Individual users exempt from detection"
      >
