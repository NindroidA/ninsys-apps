...
export function MenuEditor({
	...
	return (
		<div className="space-y-6">
			...
			{/* Menu Settings */}
			<ConfigSection title="Menu Settings" description="Configure the menu name, channel, and mode">
				<div>
			...
			>
				...
				{isAddingOption ? (
					...
					<Button variant="outline" onClick={() => setIsAddingOption(true)} className="w-full">
			...
			<div className="flex items-center gap-2 flex-wrap">
				<Button variant="outline" onClick={handleValidate} disabled={validateMenu.isPending}>
