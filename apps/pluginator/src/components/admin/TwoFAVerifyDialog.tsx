			...
			{open && (
				...
				>
					...
					>
						...
						<div className="mb-4">
							<label htmlFor="twofa-verify-code" className="text-sm font-medium block mb-2">
							...
							<Input
								...
								autoFocus
								onKeyDown={(e) => {
									if (e.key === "Enter" && code.length === 6 && !isLocked) onConfirm(code);
								}}
								disabled={isLocked}
							/>
						</div>
						...
						{isLocked && (
							<p className="text-sm text-red-500 mb-4" role="alert">
								Too many failed attempts. Please wait {lockCountdown}s before trying again.
							</p>
						)}
