...
import { Check, Eye, EyeOff, Key, Link2, Loader2, Pencil, Trash2, User } from "lucide-react";
					...
					<div className="flex items-center justify-between py-3 border-b border-border last:border-0">
						...
						{!connections?.google && (
							<Button
								variant="outline"
								size="sm"
								onClick={() => loginWithGoogle(`${window.location.origin}/account`)}
							>
								Connect
							</Button>
						)}
					...
					<div className="flex items-center justify-between py-3">
						...
						{!connections?.github && (
							<Button
								variant="outline"
								size="sm"
								onClick={() => loginWithGithub(`${window.location.origin}/account`)}
							>
								Connect
							</Button>
						)}
