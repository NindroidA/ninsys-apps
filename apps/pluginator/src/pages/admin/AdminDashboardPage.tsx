			...
			<FadeIn delay={0.15}>
				<div className="rounded-xl border border-border bg-card p-6">
					<div className="flex items-center justify-between mb-4">
						...
						<Link to="/admin/tier-history" className="text-sm text-primary hover:underline">
							View all
						</Link>
					</div>
					{!overview?.recentTierChanges?.length ? (
						<p className="text-sm text-muted-foreground py-4">No recent tier changes.</p>
					) : (
							...
							{overview.recentTierChanges.slice(0, 5).map((change) => (
								...
								>
									<div className="min-w-0">
										<p className="text-sm font-medium">{change.userEmail || change.userId}</p>
			...
			<FadeIn delay={0.2}>
				<div className="rounded-xl border border-border bg-card p-6">
					...
					{!overview?.recentAuditLog?.length ? (
						<p className="text-sm text-muted-foreground py-4">No recent admin actions.</p>
					) : (
						<div className="space-y-3">
