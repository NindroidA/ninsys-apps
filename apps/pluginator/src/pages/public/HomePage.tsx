...
function FloatingElements({
  ...
  const color =
    variant === "default" ? "rgb(168, 85, 247)" : "rgb(139, 92, 246)";
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <motion.div
            ...
            style={{
              ...
              boxShadow:
                "0 0 20px rgb(168, 85, 247), 0 0 40px rgb(168, 85, 247)",
            }}
          />
          {/* Diamond */}
          <motion.div
        ...
        >
          <FadeIn className="max-w-4xl mx-auto text-center">
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-amber-500/25 via-orange-500/25 to-rose-500/25 backdrop-blur-sm border border-amber-500/40 shadow-[0_0_20px_rgba(245,158,11,0.15)] mb-8"
            >
            ...
            >
              Update, sync, and backup plugins across all your servers. One
              tool, multiple sources, zero hassle.
            </motion.p>
      ...
      <div className="bg-card/50">
                  ...
                  {[
                    {
                      ...
                      sublabel: "TypeScript & Bun",
                    },
                    {
                      icon: Archive,
                      label: "Smart Backups",
                      sublabel: "Auto-backups",
                    },
                    {
                      icon: Globe,
                      label: "8 Sources",
                    ...
                    },
                    {
                      icon: Clock,
                      label: "Time Saver",
                      sublabel: "One command",
                    },
                  ].map((item, index) => {
                    const itemProgress = Math.max(
                      0,
                      Math.min(1, (progress - index * 0.08) * 1.5)
                    );
                    return (
                      <motion.div
                        key={item.label}
              ...
              <ScrollProgress start="top 85%" end="top 50%">
                {({ progress }) => (
                  <p
                    ...
                    style={{ opacity: Math.max(0.4, progress) }}
                  >
                    From a single server to an entire network, Pluginator scales
                    with your needs.
                  </p>
                )}
              </ScrollProgress>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 max-w-7xl mx-auto">
              {features.map((feature, index) => (
                <motion.div
                  ...
                  className="group rounded-2xl border border-border bg-card p-6 sm:p-8 hover:border-primary/50 hover:shadow-xl hover:shadow-primary/5 transition-[border-color,box-shadow] duration-500"
                >
                  <motion.div
            ...
            <div className="grid sm:grid-cols-3 gap-12 max-w-5xl mx-auto">
              {[
                ...
                },
                {
                  ...
                  title: "Check",
                  description:
                    "Run one command to check for updates across all sources.",
                },
                {
                  step: "3",
                  title: "Update",
                  description:
                    "Apply updates safely with automatic backups before changes.",
                },
              ].map((item, index) => (
                      ...
                      >
                        <motion.div
                          ...
                          style={{
                            boxShadow: `0 0 ${
                              itemProgress * 30
                            }px rgba(168, 85, 247, ${itemProgress * 0.5})`,
                          }}
                    ...
                    {[
                      {
                        title: "Free Forever",
                        description:
                          "No hidden fees, no trials. Core features are always free.",
                      },
                      {
                      ...
                      {
                        title: "Fast Updates",
                        description: "Check all your plugins in seconds.",
                      },
                    ].map((item, index) => {
                      const itemProgress = Math.max(
                        0,
        ...
        <section className="py-12 relative">
          <div className="container mx-auto px-4">
            <FadeIn>
              <div className="max-w-3xl mx-auto rounded-2xl bg-gradient-to-br from-amber-500/25 via-orange-500/25 to-rose-500/25 backdrop-blur-sm border border-amber-500/40 shadow-[0_0_30px_rgba(245,158,11,0.2)]">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold mb-2">
                        Pluginator is in Public Beta
                      </h3>
                      <p className="text-muted-foreground text-sm mb-3">
                        We're actively developing and improving Pluginator. If
                        you encounter any bugs or have feature requests, let us
                        know!
                      </p>
                      <a
            ...
            <ScrollProgress start="top 90%" end="top 40%">
              {({ progress }) => (
                ...
                >
                  ...
                  >
                    Join a growing community of server owners simplifying their
                    plugin workflow.
                  </p>
                  <motion.div
