				...
				>
					<FadeIn className="max-w-4xl mx-auto text-center">
						...
						>
							...
							<span className="text-sm font-medium text-amber-500">Open Beta - Try it now</span>
						</motion.div>
							...
							<div className="max-w-3xl mx-auto rounded-2xl bg-gradient-to-br from-amber-500/25 via-orange-500/25 to-rose-500/25 backdrop-blur-sm border border-amber-500/40 shadow-[0_0_30px_rgba(245,158,11,0.2)]">
								<div className="rounded-2xl p-6 sm:p-8">
									<div className="flex items-start gap-4">
										...
										<div>
											<h3 className="text-lg font-semibold mb-2">Pluginator is in Public Beta</h3>
											<p className="text-muted-foreground text-sm mb-3">
												We're actively developing and improving Pluginator. If you encounter any
												bugs or have feature requests, let us know!
											</p>
											<a
						...
						<ScrollProgress start="top 90%" end="top 40%">
							{({ progress }) => (
								...
								>
									...
									>
										Join a growing community of server owners simplifying their plugin workflow.
									</p>
									<motion.div
