			...
			<div className="container mx-auto px-4 relative z-10">
				...
				<div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
					{[
						...
						{ label: "Plugins Tracked", value: serverStats.plugins, icon: Puzzle },
				...
				>
					<div className="rounded-xl border border-border bg-card p-6 mb-8">
						...
						<div className="flex flex-wrap gap-4">
							{[
								{ icon: RefreshCw, label: "Check All Updates", variant: "primary" as const },
								{ icon: HardDrive, label: "Create Backup", variant: "outline" as const },
								{ icon: Server, label: "Add Server", variant: "outline" as const },
							].map((action, index) => (
								<motion.div
									key={action.label}
									initial={{ opacity: 0, x: -20 }}
