							...
							<section className="rounded-xl border border-border bg-card p-6">
								...
								<dl className="space-y-3 text-sm">
									<div className="flex justify-between">
										...
										<dd className="font-medium">{typeInfo?.name ?? theme.type}</dd>
									</div>
									<div className="flex justify-between">
										<dt className="text-muted-foreground">Category</dt>
										<dd className="font-medium">{categoryInfo?.name ?? theme.category}</dd>
									</div>
									<div className="flex justify-between">
										<dt className="text-muted-foreground">Requires</dt>
										<dd className="font-medium">{tierInfo?.name ?? theme.minTier} Tier</dd>
									</div>
									{theme.downloads && (
										<div className="flex justify-between">
